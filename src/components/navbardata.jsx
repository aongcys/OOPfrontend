        ...
        <div className='mt-[0.75%]'>
            <div className={small ? 'ml-[10%]' : 'ml-[4%]'}>
                ...
                <div className='flex flex-row mt-[0.5%] gap-[1.5%] items-center'>
                    <img className='w-[2.8%] h-[2.05rem] rounded-full border-2 border-black' src="rsna.png" alt="" />
                ...
                <div>
                    <ul className="flex flex-row gap-[2%] mt-[1.5%] h-[3rem] items-center ml-[2%]">
                        <li className=''><a href='/' className='[text-shadow:_0_0.5px_0.5px_rgb(0_0_0)]'>Overview </a></li>
                        <li><a href='./data' className='hover:[text-shadow:_0_0.5px_0.5px_rgb(0_0_0)] '>Data</a>
